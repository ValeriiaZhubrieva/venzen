(() => {
    ...
    document.addEventListener("click", (e => {
        ...
        const videoBlock = document.querySelector(".video__body video");
        if (targetElement.closest(".video__play-btn")) {
            targetElement.closest(".video__body").classList.add("video-play");
